...
//
//    /**
//     * Genera un flujo XML completo con múltiples JOBS a partir de los datos de malla
//     */
...
//
//                    // JOB FILEWATCHER (argumentos 39-56)
...
//                    datos.getTeamEmail(),
//
//                    // Jobs restantes generados por métodos separados
//                    generarJobHammurabiStaging(datos),
//                    generarJobKirbyRaw(datos),
//                    generarJobHammurabiRaw(datos),
//                    generarJobKirbyMaster(datos),
//                    generarJobHammurabiMaster(datos),
//                    generarJobErase1(datos),
//                    generarJobErase2(datos)
//            );
//
//        } catch (Exception e) {
...
public class XmlMallaGenerator {
    ...
    public String generarFlujoCompletoXml(MallaRequestDto datos) throws HandledException {
        try {
            // Generar cada JOB por separado para evitar problemas de format
