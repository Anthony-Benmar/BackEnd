...
public class ApiJiraName {
    ...
    public static final String URL_API_JIRA_PULL_REQUEST = URL_API_BASE + "/rest/dev-status/latest/issue/detail?issueId=";
    public static final String URL_API_JIRA_SQL = URL_API_BASE + "/rest/api/latest/search?jql=";
