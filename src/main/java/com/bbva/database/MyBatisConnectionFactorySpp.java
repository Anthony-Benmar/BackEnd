...
public class MyBatisConnectionFactorySpp {
    private static final Logger LOGGER = Logger.getLogger(MyBatisConnectionFactorySpp.class.getName());
    ...
    private MyBatisConnectionFactorySpp() {}
        ...
        try {
            ...
            if (EnvironmentUtils.isLocalEnvironment()) {
                ...
                config.addDataSourceProperty("cloudSqlInstance",
                        properties.getProperty("database.cloud_sql_instancespp"));
